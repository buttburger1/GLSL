...
public:
	...
	glm::mat4 projection,
	view, viewCamera1,
	ModelMatrix, MVP, RotationMatrix, RotationMatrixArray[90000], TranslationMatrix, ScalingMatrix,
	mat4Rot,
	//LIGHT
	...
	*/
	...
	bool verticesfound, normalsfound, uvmapfound, colorsfound, indicesfound,
	//LOC
	...
	int verticescount, normalscount, uvmapscount, colorscount, indicescount,
	//LOC
