//BY BUTTBURGER 1/24/2024 EXPORT
//TRS IDENTITY
...
int main()
{
		...
		//for(float i = 0.0f; i < 1.0f; i += 0.1f)
	{
		...
		*/
		...
		//printf("FIRST VBO\n");
		drawVBO(dObj.VBOloadedID, dObj.materialShaderID, DAEfile, DAEtexture);
		//printf("SECOND VBO\n");
		drawVBO(dObj.VBOloadedID, dObj.programShapesShaderID, "box_red.dae", DAEtexture);
		//printf("THIRD VBO\n");
		drawVBO(dObj.VBOloadedID, dObj.programShapesShaderID, "box_green.dae", DAEtexture);
		//printf("FOURTH VBO\n");
		drawVBO(dObj.VBOloadedID, dObj.programShapesShaderID, "box_blue.dae", DAEtexture);
		//printf("FIFTH VBO\n");
		drawVBO(dObj.VBOloadedID, dObj.materialShaderID, "test.dae", DAEtexture);
